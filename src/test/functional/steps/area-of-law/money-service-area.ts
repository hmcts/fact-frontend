...
When(
  'I select {string} from the areas of law page and continue',
  async (option: string) => {
...
Then(
  'I can select a {string} from the money area of law page',
  async (option: string) => {
    let element;
    switch (option) {
      case 'money claims': {
...
Given(
  'I continue having not selected an money area of law option',
  async () => {
    I.click('.continue');
  },
);
