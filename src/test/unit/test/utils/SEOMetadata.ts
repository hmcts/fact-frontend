  ...
  describe('generateCourtMetadata', () => {
    test('Should return in-person-court SEO metadata object', async () => {
      ...
      const expectedResult = {
        ...
        '@id':
          config.get('services.frontend.url') + '/courts/test-in-person-court',
      ...
      expect(
        generatePlaceMetadata(courtDetailsResult as CourtDetailsResult),
    ...
    test('Should return non-in-person-court SEO metadata object', async () => {
      ...
      const expectedResult = {
        ...
        '@id':
          ...
          '/courts/test-not-in-person-court',
        image: [
          config.get('services.frontend.url') +
